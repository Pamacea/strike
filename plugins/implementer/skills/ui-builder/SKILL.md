---
name: ui-builder
description: UI implementation agent - Builds unique interfaces from enriched prompts with anti-pattern validation
version: 1.0.0
---
...
2. **Read anti-pattern blacklist** from the spec
3. **Read constraints** from the spec
...
- ❌ Neon colors, gradient mesh, blob morphing from blacklist
...
- Document the conflict and resolution in README
...
*UI Builder v1.0.0 — Build unique, validate thoroughly, document everything*
